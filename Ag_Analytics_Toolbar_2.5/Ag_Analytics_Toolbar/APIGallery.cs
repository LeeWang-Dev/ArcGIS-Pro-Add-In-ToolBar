...
{
    internal class APIGallery : Gallery
    {
        ...
        private void Initialize()
        {
            ...
            foreach (var component in Categories.GetComponentElements("API_Gallery"))
            {
                try
                {
                    ...
                    if (plugin != null)
                    {
                        Add(new APIGalleryItem(component.ID, group, plugin));
                    }
                }
                catch (Exception e)
                {
        ...
        {
            var galleryItem = item as APIGalleryItem;
            galleryItem.Execute();
        }
    }
}
